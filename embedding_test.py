...
tokenizer = AutoTokenizer.from_pretrained('../llms/Qwen/Qwen3-Embedding-0.6B', padding_side='left')
model = AutoModel.from_pretrained('../llms/Qwen/Qwen3-Embedding-0.6B')
